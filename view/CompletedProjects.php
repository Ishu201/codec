                                      ...
                                      while ($row = $result->fetch_array()) { ?>
                                        <tr>
                                            <td>
                                              ...
                                              <?php
                                                $sql_protask = "SELECT * FROM project_maintenance WHERE stat='completed' AND view='yes' AND projectID='{$row['projectID']}'";
                                            ...
                                            <td><?php echo $row['real_enddate']; ?></td>
                                            <?php
                                            $pempID = $row['empID'];
                                            ...
                                            <td>
                                              <a href="editCProject.php?projectID=<?php echo $row['projectID'] ?>"><button type="submit" class="btn-sm btn btn-success" >Maintenance</button></a>
                                            </td>
                                        </tr>
                                      <?php } ?>
                                    </tbody>
