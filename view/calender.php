...
<body>
  ...
  ?>
    ...
    <script type="text/javascript">
      document.getElementById('calander').className = 'active';
    </script>
                              ...
                              <div id="external-events" class="m-t-20">
                                ...
                                <?php if ($_SESSION['username'] == 'Admin') { ?>
                                  <div class="external-event bg-primary" data-class="bg-primary">
                                    <i class="fa fa-move"></i>Director Meeting
                                  </div>
                                  <div class="external-event bg-warning" data-class="bg-warning">
                                    <i class="fa fa-move"></i>Project Analyzing
                                  </div>
                                  <div class="external-event bg-danger ui-draggable ui-draggable-handle" data-class="bg-danger" style="position: relative;">
                                    <i class="fa fa-move"></i>Department Meeting
                                  </div>
                                  <?php } elseif ($_SESSION['username'] == 'Accounts') { ?>
                                    <div class="external-event bg-info" data-class="bg-primary">
                                      <i class="fa fa-move"></i>Account Balancing
                                    </div>
                                    <div class="external-event bg-warning" data-class="bg-warning">
                                      <i class="fa fa-move"></i>Pay Check Payment
                                    </div>
                                    <div class="external-event bg-danger ui-draggable ui-draggable-handle" data-class="bg-danger" style="position: relative;">
                                      <i class="fa fa-move"></i>Department Meeting
                                    </div>
                                  <?php } elseif ($_SESSION['username'] == 'HR') { ?>
                                    <div class="external-event bg-dark" data-class="bg-primary">
                                      <i class="fa fa-move"></i>Intern Recruitment
                                    </div>
                                    <div class="external-event bg-danger ui-draggable ui-draggable-handle" data-class="bg-danger" style="position: relative;">
                                      <i class="fa fa-move"></i>Department Meeting
                                    </div>
                                  <?php } elseif ($_SESSION['username'] == 'Development') { ?>
                                    <div class="external-event bg-primary" data-class="bg-primary">
                                      <i class="fa fa-move"></i>Client Meeting
                                    </div>
                                    <div class="external-event bg-warning" data-class="bg-warning">
                                      <i class="fa fa-move"></i>Project Member Meeting
                                    </div>
                                    <div class="external-event bg-danger ui-draggable ui-draggable-handle" data-class="bg-danger" style="position: relative;">
                                      <i class="fa fa-move"></i>Department Meeting
                                    </div>
                                  <?php } else{ ?>
                                    <div class="external-event bg-primary" data-class="bg-primary">
                                      <i class="fa fa-move"></i>Leave Apply Dates
                                    </div>
                                    <div class="external-event bg-warning" data-class="bg-warning">
                                      <i class="fa fa-move"></i>Salary Date
                                    </div>
                                    <div class="external-event bg-danger ui-draggable ui-draggable-handle" data-class="bg-danger" style="position: relative;">
                                      <i class="fa fa-move"></i>Special Meeting
                                    </div>
                                  <?php   } ?>
