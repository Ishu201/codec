                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Company Leaves and Holidays</span></h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
              ...
              CalendarApp.prototype.onDrop = function (eventObj, date) {
                  var $this = this;
                      ...
                      $this.$calendar.fullCalendar('renderEvent', copiedEventObject, true);
                         ...
                         //   url: '/codec/view/operation/cevent_add.php', // get the route value
                         //   data: {titleget:titleget,startdate:startdate,classnameget:classnameget,col:col}, //set data
                         // }).done(function (data) {
                         //   console.log(data);
                  ...
                  var $this = this;
                      ...
                      $this.$modal.find('.delete-event').show().end().find('.save-event').hide().end().find('.modal-body').empty().prepend(form).end().find('.delete-event').unbind('click').on("click", function () {
                          ...
                          $.ajax({
                            type: "GET", //we are using GET method to get data from server side
                            url: '/codec/view/operation/cevent_add.php', // get the route value
                            data: {start:date,col:col}, //set data
                          }).done(function (data) {
                            console.log(data);
                            $(document).ready(function() {
                              toastr.success('Event is Removed','Successfull.. !!!',{
                      ...
                      $this.$modal.find('form').on('submit', function () {
                          ...
                          $.ajax({
                            type: "GET", //we are using GET method to get data from server side
                            url: '/codec/view/operation/cevent_add.php', // get the route value
                            data: {title:ctitle,start:start_date,col:col}, //set data
                          }).done(function (data) {
                            console.log(data);
                            $(document).ready(function() {
                              toastr.success('Event is Modified','Successfull.. !!!',{
                                  "positionClass": "toast-top-right",
                                  timeOut: 5000,
                                  "closeButton": true,
                                  "debug": false,
                      ...
                      $this.$modal.find('form').on('submit', function () {
                          ...
                          if (title !== null && title.length != 0) {
                              ...
                              $.ajax({
                                type: "GET", //we are using GET method to get data from server side
                                url: '/codec/view/operation/cevent_add.php', // get the route value
                                data: {title:title,start:finalstart,end:finalend,classname:categoryClass,col:col}, //set data
                              }).done(function (data) {
                                console.log(data);
                                $(document).ready(function() {
                                  toastr.success('Event is Created','Successfull.. !!!',{
                                      "positionClass": "toast-top-right",
                                      timeOut: 5000,
                                      "closeButton": true,
                                      "debug": false,
