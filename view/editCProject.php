                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 p-l-0 title-margin-left">
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="CompletedProjects.php">Completed Projects</a></li>
                                    <li class="breadcrumb-item myactive">Project Maintenance</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <section id="main-content">
                  ...
                  <?php include('src/projectEditAlert.php'); ?>
                      ...
                      <div class="card">
                        <div class="card-body p-b-0">
                            ...
                            <div class="tab-pane active p-20" id="personal" role="tabpanel">
                                ...
                                <div class="col-lg-8">
                                  <div class="basic-form">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                          <div class="form-group">
                                              <label>Final End Date <span style="color:red">*</span></label>
                                              <input type="date"  class="form-control" name="endDate" value="<?php echo $row['real_enddate']; ?>"  required>
                                          </div>
                                        </div>
                                      </div>
                              ...
                              <div class="row">
                                <div class="col-lg-12">
                                  ...
                                  <textarea class="form-control" rows="3" placeholder="Project Description" name="description" style="height:150px" required><?php echo $row['description']; ?></textarea>
                                </div>
                              </div> <br> <br>
                              ...
                              <div class="row">
                                <div class="col-lg-4 col-sm-6">
                                  <div class="form-group">
                                      ...
                                      <input type="text"  class="form-control" name="customer_name" value="<?php echo $row['customer_name']; ?>" readonly  required>
                                  </div>
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                  <div class="form-group">
                                      <label>Customer Company <span style="color:red">*</span></label>
                                      <input type="text"  class="form-control" name="customer_company" value="<?php echo $row['customer_company']; ?>"   required readonly>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-lg-4 col-sm-6">
                                  <div class="form-group">
                                      ...
                                      <input type="text"  class="form-control" name="customer_address" value="<?php echo $row['customer_address']; ?>"   required readonly>
                                  </div>
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                  <div class="form-group">
                                      <label>Contact Number <span style="color:red">*</span></label>
                                      <input type="text"  class="form-control" name="customer_contact" value="<?php echo $row['customer_contact']; ?>" readonly  required pattern="[0-9]{10}"  required min="10" maxlength="10">
                                  </div>
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                  <div class="form-group">
                                      <label>Customer Email<span style="color:red">*</span></label>
                                      <input type="text"  class="form-control" name="customer_email" value="<?php echo $row['customer_email']; ?>" readonly required>
                                  </div>
                                </div>
                              </div>
                            ...
                            <!-- project member -->
                              ...
                              <div class="row">
                                <div class="col-lg-12">
                                  <form class="" action="controller/Cprojectcontroller.php?stat=addDeveloper&projectID=<?php echo $projectID; ?>" method="post">
                                    <div class="row"><div class="col-lg-4">
                                      <label>Select a Developer <span style="color:red">*</span></label>
                                      <select class="form-control" name="empID" required style="text-transform:capitalize">
                                        ...
                                        while ($row_team = $result_team->fetch_array()) {
                                          ...
                                          $sql_checkteamg = "SELECT * FROM project_members WHERE empID='$_team' AND projectID!='$projectID' AND project_members.stat='on' AND project_members.memberType='Initial Development'";
                                          $result_checkteamg = $con->query($sql_checkteamg);
                                          $counttg = $result_checkteamg->num_rows;

                                          if (($countt > 0) or ($counttg > 0)) {

                                          } else{
                                            $sql_checkteam2 = "SELECT * FROM project_members WHERE empID='$_team' AND projectID!='$projectID' AND project_members.stat='on' AND project_members.memberType='Maintenance Developing'";
                              ...
                              <?php
                              $sql_projectmember22 = "SELECT employee.*,project_members.* FROM project_members INNER JOIN employee ON employee.empID=project_members.empID WHERE project_members.projectID='$projectID' AND project_members.stat='off' AND project_members.memberType='Maintenance Developing'";
                              ...
                              if($count22 > 0){
                                ...
                                <div class="card-title">
                                <h4>Previous Maintenance Developers</h4>
                              </div>
                                <div class="row">
                                ...
                                <?php }  ?>
                                  ...
                                  <?php
                                  $sql_projectmember22 = "SELECT employee.*,project_members.* FROM project_members INNER JOIN employee ON employee.empID=project_members.empID WHERE project_members.projectID='$projectID' AND project_members.stat='off' AND project_members.memberType='Initial Development'";
                                  $result_projectmember22 = $con->query($sql_projectmember22);
                                  $count22 = $result_projectmember22->num_rows;
                                  if($count22 > 0){
                                    ?>
                    ...
                    <div class="tab-pane  p-20" id="tasklist" role="tabpanel">
                              ...
                              <!-- <form action="controller/Cprojectcontroller.php?stat=mainTaskt&projectID=<?php //echo $projectID; ?>" method="post" style="display:none" class="editTask">
                              ...
                              <div class="col-lg-12" >
                                ...
                                <form class="" action="controller/Cprojectcontroller.php?stat=save_mainTask&projectID=<?php echo $projectID; ?>&numb=<?php echo $k; ?>" method="post">
                              ...
                              ?>
                                ...
                                ?>
                                <form class="" action="controller/Cprojectcontroller.php?stat=save_subTask&projectID=<?php echo $projectID; ?>&numb=<?php echo $kk; ?>&mainID=<?php echo $k; ?>" method="post">
                                    ...
                                    while ($row_pdocs = $result_pdocs->fetch_array()) {
                                      ...
                                      <tr>
                                        ...
                                        while ($row_projectmemberp2 = $result_projectmemberp2->fetch_array()) {
                                          ...
                                          <form class="" action="controller/Cprojectcontroller.php?stat=priviliges&empID=<?php echo $eeID; ?>&docID=<?php echo $row_pdocs['p_docID']; ?>&projectID=<?php echo $projectID; ?>" method="post">
                                  ...
                                  <div class="row">
                                    <div class="col-lg-12">
                                      ...
                                      <div class="basic-form">
                                        ...
                                        <form class="" action="controller/Cprojectcontroller.php?stat=addDoc&projectID=<?php echo $projectID; ?>" method="post" enctype="multipart/form-data" >
                                          <div class="row">
                                            <div class="col-lg-6 col-sm-6">
                                              <div class="form-group">
                            ...
                            <!-- project legal documents -->
                              ...
                              <div class="row">
                                ...
                                <div class="basic-form">
                                  ...
                                  <form class="" action="controller/Cprojectcontroller.php?stat=addLDoc&projectID=<?php echo $projectID; ?>" method="post" enctype="multipart/form-data" >
                                      <div class="row">
                                        <div class="col-lg-6 col-sm-6">
                                          <div class="form-group">
                                              <label>Document Title <span style="color:red">*</span> </label>
                          ...
                          <?php } ?>
                            ...
                            <div class="tab-pane p-20" id="notes" role="tabpanel">
                              <div class="todo-list" id="taskTable">
                                  <div class="tdl-holder">
                                      ...
                                      ?>
                                      <form action="controller/Cprojectcontroller.php?stat=addnote&projectID=<?php echo $projectID; ?>" method="post">
                            ...
                            <div class="tab-pane p-20" id="income" role="tabpanel">
                              <div class="card-title">
                                  <h4>Assign Tasks To Developers</h4>
                              </div> <br>
                              <form action="controller/Cprojectcontroller.php?stat=addMtask&projectID=<?php echo $projectID; ?>" method="post">
                                <div class="row">
                                  <div class="col-lg-4">
                                    <select class="form-control" name="developerID" required>
                                      <option value="">Select a Developer</option>
                                      <?php
                                      $sql_getEmps = "SELECT * FROM project_members WHERE projectID='$projectID' AND stat='on' AND memberType='Maintenance Developing'";
                                      $result_getEmps = $con->query($sql_getEmps);
                                      while ($row_getEmps = $result_getEmps->fetch_array()) {
                                        $empp = $row_getEmps['empID'];
                                          $sql_name = "SELECT * FROM employee WHERE empID='$empp'";
                                          $result_name = $con->query($sql_name);
                                          $row_name = $result_name->fetch_array();
                                      ?>
                                      <option value="<?php echo $empp; ?>"><?php echo $row_name['empName']; ?></option>
                                      <?php } ?>
                                    </select>
                                  </div>
                                  <div class="col-lg-4">
                                    <select class="form-control" name="type" name="developerID" required>
                                      <option value="">Select Task type</option>
                                      <option value="New developments in ERP systems">New developments in ERP systems </option>
                                      <option value="Report changes / developments">Report changes / developments </option>
                                      <option value="Website creation / changes / tech issues">Website creation / changes / tech issues  </option>
                                      <option value="Changes in existing ERP systems">Changes in existing ERP systems </option>
                                      <option value="UI developments">UI developments </option>
                                      <option value="Payment gateway / SMS gateway integration">Payment gateway / SMS gateway integration</option>
                                      <option value="Special tasks">Special tasks </option>
                                    </select>
                                  </div>
                                  <div class="col-lg-4">
                                    <select class="form-control" name="priority" name="developerID" required>
                                  ...
                                  <div class="col-lg-8"> <br>
                                    <input type="text" class="form-control" name="Mtask" placeholder="Assign a New Task.." required>
                                  </div>
                                  <div class="col-lg-4"> <br>
                                    <input type="date" name="dueDate" min="<?php echo date('Y-m-d') ?>" class="form-control" required >
                                  </div>
                              ...
                              <div class="row">
                                <div class="col-lg-2 col-sm-12" style="font-size:15px;font-weight:bold;text-align:center;color:#343957">
                                  Total Tasks <br>
                                  <?php
                                  $sql_1 = "SELECT * FROM `project_maintenance` WHERE projectID='$projectID' AND view='yes'";
                                ...
                                <div class="col-lg-2 col-sm-12" style="font-size:15px;font-weight:bold;text-align:center;color:#343957">
                                  Todo <br>
                                  <?php
                                  $sql_1 = "SELECT * FROM `project_maintenance` WHERE projectID='$projectID'  AND stat='TODO' AND view='yes'";
                                  $result_1 = $con->query($sql_1);
                                  $count_1 = $result_1->num_rows;
                                  if ($count_1 <= 0) {
                                    $count_1 = 0;
                                ...
                                <div class="col-lg-2 col-sm-12" style="font-size:15px;font-weight:bold;text-align:center;color:#343957">
                                  In Progress <br>
                                  <?php
                                  $sql_1 = "SELECT * FROM `project_maintenance` WHERE projectID='$projectID'  AND stat='in progress' AND view='yes'";
                                  $result_1 = $con->query($sql_1);
                                  $count_1 = $result_1->num_rows;
                                  if ($count_1 <= 0) {
                                    $count_1 = 0;
                                ...
                                <div class="col-lg-2 col-sm-12" style="font-size:15px;font-weight:bold;text-align:center;color:#343957">
                                  To Review <br>
                                  <?php
                                  $sql_1 = "SELECT * FROM `project_maintenance` WHERE projectID='$projectID'  AND stat='completed' AND view='yes'";
                                  $result_1 = $con->query($sql_1);
                                  $count_1 = $result_1->num_rows;
                                  if ($count_1 <= 0) {
                                    $count_1 = 0;
                                ...
                                <div class="col-lg-2 col-sm-12" style="font-size:15px;font-weight:bold;text-align:center;color:#343957">
                                  Completed <br>
                                  <?php
                                  $sql_1 = "SELECT * FROM `project_maintenance` WHERE projectID='$projectID'  AND stat='reviewed' AND view='yes'";
                                  $result_1 = $con->query($sql_1);
                                  $count_1 = $result_1->num_rows;
                                  if ($count_1 <= 0) {
                                    $count_1 = 0;
                              ...
                              <?php
                              $sql_notes2 = "SELECT * FROM `project_maintenance` WHERE projectID='$projectID' AND view='yes' ORDER BY id DESC";
                                ...
                                <thead>
                                  ...
                                  <tbody>
                                    ...
                                    while ($row_notes2 = $result_notes2->fetch_array()) {
                                      ...
                                      $getemp = $row_notes2['empID'];
                                      $sql_setEmpName = "SELECT * FROM employee WHERE empID='$getemp'";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <?php if ($level == 'completed'){ ?>
                                            <a href="operation/reviewTask.php?id=<?php echo $row_notes2['id']; ?>&projectID=<?php echo $projectID; ?>&type=<?php echo $row_notes2['type']; ?>" ><span style="text-transform:capitalize" class="badge badge-<?php echo $badge ?>"><?php echo $row_notes2['stat'] ?></span></a>
                                          <?php } else {  ?>
                                            <span style="text-transform:capitalize" class="badge badge-<?php echo $badge ?>"><?php echo $row_notes2['stat'] ?></span>
                                          <?php } ?>
                                        </td>
                                        <td><button type="button" style="margin-right:5px;background-color:white;font-weight:bold;font-size:18px;" class="btn-sm  btn sweet-message4 "  data-id="<?php echo $row_notes2['id']; ?>"  data-project="<?php echo $projectID; ?>">x</button></td>
                                    </tr>
                                    <?php $no++; } ?>
                                  </tbody>
                              </table>
